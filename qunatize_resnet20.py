...
class regularized_padded_conv(keras.layers.Layer):
    def __init__(self, padding name, dtype, dynamic, **kwargs):
...
class Resnet(keras.Model):
    def __init__(self,input_shape, n_classes,quantizer, l2_reg=1e-4, group_sizes=(2, 2, 2), 
        ...
        self.dense = ql.quantizeDense(n_classes,_regularizer,self.to_fix_fn)
